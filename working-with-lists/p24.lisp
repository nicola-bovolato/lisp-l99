...
(format t "~S~%" (lotto-select 0 0))
(format t "~S~%" (lotto-select 1 0)) 
(format t "~S~%" (lotto-select 0 1)) 
(format t "~S~%" (lotto-select 1 10)) 
(format t "~S~%" (lotto-select 6 10)) 
(format t "~S~%" (lotto-select 10 6)) 
(format t "~S~%" (lotto-select 10 10)) 
