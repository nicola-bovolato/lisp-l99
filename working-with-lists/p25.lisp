...
(format t "~S~%" (rnd-permutation nil))
(format t "~S~%" (rnd-permutation '())) 
(format t "~S~%" (rnd-permutation '(A B C))) 
(format t "~S~%" (rnd-permutation '(A B C D))) 
(format t "~S~%" (rnd-permutation '(A B C D E F G H))) 